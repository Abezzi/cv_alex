...
\begin{itemize}
  ...
  \item Resolví incidencias y optimicé la experiencia de usuarios en un sistema municipal al brindar soporte técnico especializado, orientando a personas con dificultades para utilizar diversas funcionalidades del sistema; mi tarea fue generar "informes de transparencia". Logré mejorar la satisfacción de los usuarios y garantizar el acceso transparente a la información pública, fortaleciendo la confianza en el sistema.
\end{itemize}
...
\vspace{-9pt}
\begin{itemize}
  \item Sistema para la administración de restaurantes o servicios similares. Características que contiene son: monorepo, punto de venta, perfiles, autenticación, i18n, throttle, perfiles para la autoridad, modo nocturno.
\end{itemize}
\textbf{FitnessApp Aplicación Móvil H\'ibrida} \hfill \href{https://github.com/Abezzi/sofi-workout/}{github.com/abezzi/sofi-workout} \\
\vspace{-9pt}
\begin{itemize}
  \item Desarrollé una aplicación móvil para entrenamiento f\'isico que incluye: autenticación, creación de rutinas/ejercicios, entrenamientos arrastrables, calendario histórico, rutinas, i18n y modo oscuro.
\end{itemize}
